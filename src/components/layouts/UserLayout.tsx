    ...
    <Theme appearance="light" accentColor="indigo" radius="medium">
      <Flex direction="column" style={{ minHeight: '100vh', background: 'var(--gray-2)' }}>
                  ...
                  <DropdownMenu.Content style={{ width: '320px' }}>
                    <Box p="3">
                      <Flex justify="between" align="center" mb="3">
                        <Text weight="bold" size="3">Notifikasi</Text>
                        ...
                        <Flex direction="column" gap="3">
                          <Box p="2" style={{ borderRadius: '8px', background: 'var(--amber-3)' }}>
                            <Flex gap="2" align="start">
                              ...
                              <Box style={{ flex: 1 }}>
                                <Text size="2" weight="medium">Peringatan Jatuh Tempo</Text>
                                <Text size="1" color="gray" style={{ display: 'block', marginTop: '4px' }}>
                                  "Fisika untuk SMA" akan jatuh tempo dalam 5 hari
                                </Text>
                                <Text size="1" color="gray" style={{ marginTop: '4px' }}>2 jam yang lalu</Text>
                              </Box>
                            </Flex>
                          </Box>
                          ...
                          <Box p="2" style={{ borderRadius: '8px', background: 'var(--blue-2)' }}>
                            <Flex gap="2" align="start">
                              ...
                              <Box style={{ flex: 1 }}>
                                <Text size="2" weight="medium">Buku Tersedia</Text>
                                <Text size="1" color="gray" style={{ display: 'block', marginTop: '4px' }}>
                                  "Sejarah Indonesia Modern" sudah bisa dipinjam
                                </Text>
                                <Text size="1" color="gray" style={{ marginTop: '4px' }}>5 jam yang lalu</Text>
                              </Box>
                            </Flex>
                          </Box>
                          ...
                          <Box p="2" style={{ borderRadius: '8px', background: 'var(--green-2)' }}>
                            <Flex gap="2" align="start">
                              ...
                              <Box style={{ flex: 1 }}>
                                <Text size="2" weight="medium">Poin Membaca +10</Text>
                                <Text size="1" color="gray" style={{ display: 'block', marginTop: '4px' }}>
                                  Selamat! Kamu mendapat 10 poin untuk menyelesaikan buku
                                </Text>
                                <Text size="1" color="gray" style={{ marginTop: '4px' }}>Kemarin</Text>
                              </Box>
                            </Flex>
                          </Box>
                        </Flex>
                  ...
                  <DropdownMenu.Content>
                    <DropdownMenu.Label>
                      <Flex direction="column" gap="1">
                        ...
                        <Text size="1" color="gray">{studentId}</Text>
        ...
        <Flex style={{ flex: 1 }}>
          ...
          <Box 
            style={{ display: 'none', width: '280px', background: 'white', borderRight: '1px solid var(--gray-6)' }}
            className="lg:block"
          >
              ...
              <Box p="4">
                ...
                <Card size="2" style={{ background: 'linear-gradient(135deg, var(--indigo-3) 0%, var(--purple-3) 100%)' }}>
                  <Flex direction="column" align="center" gap="3" py="3">
                    ...
                    <Box style={{ textAlign: 'center' }}>
                      <Text weight="bold" size="3">{userName}</Text>
                ...
                <Card mt="4" variant="classic">
                  <Grid columns="3" gap="3" style={{ textAlign: 'center' }}>
                    <Box>
                      <Text weight="bold" size="4" style={{ color: 'var(--indigo-11)' }}>5</Text>
                      <Text size="1" color="gray" style={{ display: 'block' }}>Dipinjam</Text>
                    </Box>
                    <Box>
                      <Text weight="bold" size="4" style={{ color: 'var(--green-11)' }}>148</Text>
                      <Text size="1" color="gray" style={{ display: 'block' }}>Poin</Text>
                    </Box>
                    <Box>
                      <Text weight="bold" size="4" style={{ color: 'var(--pink-11)' }}>12</Text>
                      <Text size="1" color="gray" style={{ display: 'block' }}>Favorit</Text>
                    </Box>
                  </Grid>
                </Card>
                ...
                <Box mt="5">
                  ...
                  <Flex direction="column" gap="1">
                    ...
                    <Button variant="ghost" size="2" style={{ justifyContent: 'flex-start' }}>
                      ...
                      <Badge ml="auto" size="1" color="gray">1500+</Badge>
                    </Button>
                    <Button variant="ghost" size="2" style={{ justifyContent: 'flex-start' }}>
                      <BackpackIcon /> Tas Buku Saya
                      <Badge ml="auto" size="1" color="red">5</Badge>
                    </Button>
                    <Button variant="ghost" size="2" style={{ justifyContent: 'flex-start' }}>
                      <HeartIcon /> Daftar Favorit
                      <Badge ml="auto" size="1" color="pink">12</Badge>
                    </Button>
                    <Button variant="ghost" size="2" style={{ justifyContent: 'flex-start' }}>
                    ...
                    {categories.map((cat) => {
                      ...
                      return (
                        ...
                        >
                          <Icon />
                          {cat.name}
                          <Text size="1" color="gray" ml="auto">{cat.count}</Text>
                        </Button>
                      );
                    })}
                  </Flex>
            ...
            <Container size="4">
                  ...
                  return (
                    <Card key={index} style={{ 
                      ...
                      <Flex direction="column" gap="3">
                        ...
                        <Box>
                          <Heading size="6" mb="1">{stat.value}</Heading>
              ...
              <Card mb="6" style={{ background: 'white' }}>
                <Flex justify="between" align="center" mb="4">
                  <Box>
                    <Heading size="5" mb="1">Buku yang Sedang Dipinjam</Heading>
                    ...
                    >
                      <Flex direction="column" gap="3">
                        <Flex justify="between" align="start">
                          <Badge
                            color={book.status === 'warning' ? 'orange' : 'green'}
                            variant="soft"
                            size="1"
                          >
                        ...
                        <Box>
                          <Heading size="3" mb="1">{book.title}</Heading>
              ...
              <Card style={{ background: 'white' }}>
                <Heading size="4" mb="4">Aksi Cepat</Heading>
                <Grid columns={{ initial: '2', sm: '3', md: '6' }} gap="3">
                  <Card variant="classic" style={{ cursor: 'pointer', transition: 'all 0.2s', textAlign: 'center' }}>
                    <Flex direction="column" align="center" gap="2" py="2">
                      ...
                      <Text size="2" weight="medium">Cari Buku</Text>
                    </Flex>
                  </Card>
                  ...
                  <Card variant="classic" style={{ cursor: 'pointer', transition: 'all 0.2s', textAlign: 'center' }}>
                    <Flex direction="column" align="center" gap="2" py="2">
                      ...
                      <Text size="2" weight="medium">Pinjam</Text>
                    </Flex>
                  </Card>
                  ...
                  <Card variant="classic" style={{ cursor: 'pointer', transition: 'all 0.2s', textAlign: 'center' }}>
                    <Flex direction="column" align="center" gap="2" py="2">
                      ...
                      <Text size="2" weight="medium">Baca</Text>
                    </Flex>
                  </Card>
                  ...
                  <Card variant="classic" style={{ cursor: 'pointer', transition: 'all 0.2s', textAlign: 'center' }}>
                    <Flex direction="column" align="center" gap="2" py="2">
                      ...
                      <Text size="2" weight="medium">Favorit</Text>
                    </Flex>
                  </Card>
                  ...
                  <Card variant="classic" style={{ cursor: 'pointer', transition: 'all 0.2s', textAlign: 'center' }}>
                    <Flex direction="column" align="center" gap="2" py="2">
                      ...
                      <Text size="2" weight="medium">Riwayat</Text>
                    </Flex>
                  </Card>
                </Grid>
              </Card>
        ...
        <Box style={{ borderTop: '1px solid var(--gray-6)', background: 'white' }} py="5">
          <Container size="4">
            <Grid columns={{ initial: '1', md: '3' }} gap="6">
              <Box>
                <Flex align="center" gap="2" mb="3">
                  ...
                  <Text size="3" weight="bold">Perpustakaan Digital</Text>
                </Flex>
              ...
              <Box>
                <Text size="2" weight="bold" mb="3" style={{ display: 'block' }}>Menu Cepat</Text>
                <Flex direction="column" gap="2">
                  <Text size="2" color="gray" style={{ cursor: 'pointer' }}>Tentang Perpustakaan</Text>
                  <Text size="2" color="gray" style={{ cursor: 'pointer' }}>Syarat & Ketentuan</Text>
                  <Text size="2" color="gray" style={{ cursor: 'pointer' }}>Panduan Peminjaman</Text>
                  <Text size="2" color="gray" style={{ cursor: 'pointer' }}>FAQ</Text>
                </Flex>
              </Box>
              
              <Box>
                <Text size="2" weight="bold" mb="3" style={{ display: 'block' }}>Hubungi Kami</Text>
                <Flex direction="column" gap="2">
                  <Flex align="center" gap="2">
                    <EnvelopeClosedIcon width="14" height="14" />
                    <Text size="2" color="gray">library@school.edu</Text>
                  </Flex>
                  <Flex align="center" gap="2">
                    <HomeIcon width="14" height="14" />
                    <Text size="2" color="gray">Gedung Perpustakaan Lt.2</Text>
                  </Flex>
                  <Flex align="center" gap="2">
                    <ClockIcon width="14" height="14" />
                    <Text size="2" color="gray">Senin - Jumat, 07:00 - 16:00</Text>
                  </Flex>
                </Flex>
              </Box>
            </Grid>
            ...
            <Flex justify="between" align="center" style={{ flexDirection: 'column', gap: '12px' }} className="md:flex-row">
              ...
              <Flex gap="3">
                <Text size="1" color="gray" style={{ cursor: 'pointer' }}>Kebijakan Privasi</Text>
                <Text size="1" color="gray">•</Text>
                <Text size="1" color="gray" style={{ cursor: 'pointer' }}>Bantuan</Text>
              </Flex>
            </Flex>
          </Container>
        </Box>
